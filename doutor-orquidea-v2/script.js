...
document.addEventListener('DOMContentLoaded', function(){
  ...
  // Fallback: se IO não disparar, mostrar tudo após 2.5s
  ...
  revealEls.forEach(el=>{
    // Se já está visível no carregamento, mostrar imediatamente
...
const slides = [
  ...
  {icon:'🌺', name:'Variedade', desc:'Epífita ou terrestre? Cada espécie tem necessidades únicas. Entenda sua planta e tudo muda.', quote:'', tags:['Epífita','Terrestre','Habitat natural'], color:'#b0407a', final:false, empty:false},
  {icon:'📍', name:'Local', desc:'O ambiente certo vale mais que qualquer produto. Encontre o lugar ideal na sua casa.', quote:'', tags:['Luz','Clima','Cobertura'], color:'#3e6b4a', final:false, empty:false},
  {icon:'🪨', name:'Substrato', desc:'Leve, médio ou pesado. Monte o substrato ideal para sua planta e sua rotina.', quote:'', tags:['Leve','Médio','Pesado'], color:'#8c5a3c', final:false, empty:false},
  {icon:'💧', name:'Irrigação', desc:'Rega demais ou de menos mata. Descubra o método certo para a sua orquídea.', quote:'', tags:['Imersão','Aspersão','Frequência'], color:'#4a7c59', final:false, empty:false},
  {icon:'🌱', name:'Adubação', desc:'Orgânico, químico ou lento. Saiba exatamente quando e como adubar.', quote:'', tags:['Orgânico','Liberação lenta','NPK equilibrado'], color:'#6b4c9a', final:false, empty:false},
  {icon:'🧑‍🌾', name:'Você no Centro', desc:'', quote:'Quando um muda, todos os outros respondem. Você, o cultivador, é quem conecta tudo.', tags:['Tudo interligado','Método completo'], color:'#b0407a', final:true, empty:false}
];
...
if(!stage||!panel||!canvas){console.warn('Mandala: elementos não encontrados.');}
